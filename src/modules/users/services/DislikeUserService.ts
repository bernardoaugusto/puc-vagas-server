...
@injectable()
export default class DislikeUserService {
  constructor(
  ...
  public async execute(
    user_id: string,
    vacancy_id: string,
    user_disliked_id: string,
  ): Promise<void> {
    if (user_id === user_disliked_id) {
    ...
    has_register_of_vacancy.dislikes.push(check_user_liked_exists.id);
